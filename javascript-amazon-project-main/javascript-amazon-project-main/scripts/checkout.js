            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-quantity">
                  ...
                  <input class="quantity-input js-quality-input-${matchingProduct.id}">
...
document.querySelectorAll('.js-save-link')
  .forEach((link) => {
    link.addEventListener('click', () => {
      ...
      const qualityInput = document.querySelector(`.js-quality-input-${productId}`);

      const newQuantity = Number(qualityInput.value);
